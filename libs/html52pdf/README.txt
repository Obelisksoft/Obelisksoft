HTML52PDF v2.0 Release Notes
============================
HTML52PDF v2.0 comes bundle with a great deal of new features that will help you
to generate beatiful business reports and general purpose document even easier
than before.
...
In HTML52PDF v2.0 templates are much more than passive receptacles for 
...
formatted content with the core API of HTML52PDF.
...
In particular HTML52PDF v2.0 comes already bundled with a "word-blue" theme that
...
HTML52PDF v1.0 Release Notes
============================

HTML52PDF is a highly sophisticated library designed to facilitate the 
generation and deployment of documentation in a web server.

HTML52PDF allows for the dynamical generation of PDF, Word, ODF and/or RTF files 
...
The generated documents may contain:
    ...
    * etcetera.
    * HTML52PDF may be used under different licenses that only differ in its 
      scope of use but not functionality:
        ** FREE, at no cost, for personal use,testing and development and 
           ...
           discreet HTML52PDF branding at the end of the document.
