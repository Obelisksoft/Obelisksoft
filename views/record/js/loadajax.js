$(document).ready(function() {
	...
	var getTable = function(){
        $.post('/search/getTable/','table=' + $("#table").val(),function(datos){
        	$("#serie").html('');
           $("#subserie").html('');
            $("#typedocment").html('');
             $(".fields").html('');
            	$("#serie").append('<option value=""> --Serie--</option>');
            for(var i = 0; i < datos.length; i++){
                $("#serie").append('<option value="' + datos[i].id_retention + '">' + datos[i].retention + '</option>');
            }
            
        }, 'json');
    }

    var getTableTVD = function(){
        $.post('/search/getTable/','table=' + $("#table").val(),function(datos){
        	$("#serie").html('');
           $("#subserie").html('');
            $("#typedocment").html('');
             $(".fields").html('');
            	$("#serie").append('<option value=""> --Serie--</option>');
            for(var i = 0; i < datos.length; i++){
                $("#serie").append('<option value="' + datos[i].id_valoration + '">' + datos[i].valoration + '</option>');
            }
